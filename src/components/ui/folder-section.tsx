  ...
  return (
    <section className={cn("mb-12", className)}>
      ...
      <div className="relative">
        ...
        <div className={cn("relative rounded-3xl pt-8 pb-8 px-8", bgClass, variant === 'trending' ? '' : 'border border-border')}>
          {children}
        </div>
        
        {/* Folder tab - positioned above the rectangle */}
        <div className={cn("absolute -top-8 left-8 rounded-t-xl px-6 py-2 min-w-fit z-10", bgClass, variant === 'trending' ? '' : 'border-l border-t border-r border-border')}>
